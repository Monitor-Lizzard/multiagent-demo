defmodule MultiAgentDemo.Agents.LLM.TechAgent do
  ...
  def characteristics do
    %{
      ...
      name: "Tech Agent",
      description:
        "Specializes in technology areas including software development, hardware, AI, and cybersecurity",
  ...
  def process_message(message, context, conversation_history) do
    ...
    # |> LLMChain.run()
    {:ok, %Message{content: "This is a response from the tech agent"}}
  end
